...
def can_be_found_updated_and_saved
  ...
  bob = Movie.find_by(title: "Awesome Flick")
  bob.update(title: "Even Awesomer Flick")
  bob.save
...
def can_update_using_update_method
  ...
  bob = Movie.find_by(title: "Wat?")
  bob.update(title: "Wat, huh?")
  bob.save
end
...
def can_destroy_a_single_item
 ...
 fog = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
fog.destroy
